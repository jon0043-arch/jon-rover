...
export default function EquityGuard({title,condition,price,mileage=null,projection}:Props){
  ...
  if(price==null||price<=0)return <div className="equityGuard equityGuardUnavailable"><div className="equityGuardHeading"><span>EQUITY GUARD</span><b>3-YEAR OUTLOOK</b></div><p>Down-payment guidance will appear when a selling price is available.</p><p className="equityGuardDisclaimer">Estimate only. Not a trade appraisal, loan quote, lending decision or financial advice.</p></div>;

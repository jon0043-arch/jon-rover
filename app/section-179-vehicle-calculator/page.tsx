...
export default function Page(){
 ...
 return <main className="blogPage">
  ...
  <div className="articleBody shell">
   ...
   <div style={{padding:"20px 22px",border:"1px solid rgba(20,20,20,.25)",margin:"20px 0 30px"}}><strong>IMPORTANT TAX DISCLAIMER</strong><p style={{margin:"8px 0 0"}}>This calculator provides a general estimate for educational purposes only. It is not tax, legal, financial or accounting advice and does not determine whether you or a vehicle qualifies for any deduction. Tax laws, depreciation rules and individual circumstances can change the actual result. <strong>Contact a qualified accountant or tax professional to confirm your eligibility and potential deduction before making a vehicle purchase based on tax benefits.</strong></p></div>
   ...
   <div className="articleCta"><p className="eyebrow">LOOKING FOR A QUALIFYING LAND ROVER?</p><h3>Find the right vehicle. Let your accountant confirm the deduction.</h3><p>I’m Jon McGeehan at Jaguar Land Rover Willow Grove. I can help you compare available vehicles and provide the vehicle information your accountant may want to review.</p><div className="articleActions"><a className="button dark" href="tel:+16092218478">CALL JON →</a><Link className="button" href="/#inventory">VIEW INVENTORY →</Link></div></div>
   <p style={{fontSize:12,opacity:.7,marginTop:30}}><strong>Disclaimer:</strong> This calculator is for general educational purposes only and is not tax, legal, financial or accounting advice. Results are estimates only and do not determine eligibility or your actual deduction. Contact a qualified accountant or tax professional regarding your specific circumstances before relying on this information. Verify the exact vehicle's GVWR and applicable tax treatment.</p>
  </div></article>
 </main>
}

...
import { competitorGuides,competitorGuideList } from "../competitor-guides";
import "../blog.css";

const siteUrl="https://www.jonrover.com";
const jonId=`${siteUrl}/#jon-mcgeehan`;
const allGuides={...guides,...competitorGuides};
const allGuideList=[...guideList,...competitorGuideList];
export function generateStaticParams(){return allGuideList.map(g=>({slug:g.slug}));}

export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{
 const {slug}=await params;const guide=allGuides[slug];if(!guide)return {};
